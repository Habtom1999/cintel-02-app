...
app_ui = ui.page_navbar(
    ...
    ui.nav(ui.a("GitHub", href="https://github.com/Habtom1999/cintel-02-app")),
    ui.nav(ui.a("App", href="https://Habtom1999.github.io/cintel-02-app/")),
...
def server(input, output, session):
    ...
    def welcome_output():
        ...
        welcome_string = f'Hello Class {user}!';
